...
//        self.window?.rootViewController = TouchScreenTest()PaPa
...
//           exit(0)
    ...
    private var brightness =  UIScreen.main.brightness
    private func DidUserPressHomeButton() -> Bool {
